        ...
        <div className="w-full max-w-sm text-center">
          ...
          <div className="mt-6 space-y-3 sm:mt-8">
            <form action={signInWithGoogle}>
              <button
                type="submit"
                className="flex w-full items-center justify-center gap-3 rounded border border-ink/20 bg-white py-3 text-sm font-medium shadow-paper-sm transition-colors hover:border-ink/30"
              >
